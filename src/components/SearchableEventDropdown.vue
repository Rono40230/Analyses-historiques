...
.dropdown-header { display: flex; align-items: center; width: 100%; padding: 12px 16px; border: 2px solid #ccc; border-radius: 8px; background: #ffffff; transition: all 0.3s; overflow: hidden; gap: 8px; box-sizing: border-box; }
...
.dropdown-menu { position: absolute; top: 100%; left: 0; width: 100%; margin-top: 4px; background: #ffffff; border: 2px solid #ccc; border-radius: 8px; max-height: 300px; overflow-y: auto; z-index: 10; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.15); }
